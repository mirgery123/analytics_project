...
d3.json('/bubblechart/').then(function(mydata) {
  ...
  // Add a scale for bubble width
  var mywidth = d3.scaleOrdinal()
  ...
  svg.append('g')
    ...
    .style("fill", function (d) { return mywidth(d.region); })
  ...
  svg.selectAll("myrect")
    ...
    .attr("r", 7)
    .style("fill", function (d) { return mywidth(d) })
